...
- The latest **Graal API documentation** is available online at https&zwnj;://www.graalvm.org/{[sdk](https://www.graalvm.org/sdk/javadoc/),[truffle](https://www.graalvm.org/truffle/javadoc/),[tools](https://www.graalvm.org/tools/javadoc/),[graphio](https://www.graalvm.org/graphio/javadoc/)}/javadoc/. For older or specific API version, the URL is https&zwnj;://www.graalvm.org/{23.1,24.0,24.1,24.2,25.0}/javadoc/{[sdk](https://www.graalvm.org/23.1/javadoc/sdk/),[truffle](https://www.graalvm.org/23.1/javadoc/truffle/),[tools](https://www.graalvm.org/23.1/javadoc/tools/),[graphio](https://www.graalvm.org/23.1/javadoc/graphio/)}/. The GitHub repo of the GraalVM website is available at https://github.com/graalvm/graalvm-website.
- [On Automating Hybrid Execution of Ahead-of-Time and Just-in-Time Compiled Code](https://dl.acm.org/doi/pdf/10.1145/3689490.3690398), Christoph Pichler, Paley Li, Roland Schatz and Hanspeter Mössenböck in Proceedings of the 16th ACM SIGPLAN International Workshop on Virtual Machines and Intermediate Languages (VMIL ’24), October 20, 2024, Pasadena, CA, USA.
